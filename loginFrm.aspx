<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginFrm.aspx.cs" Inherits="IS424_Project.loginFrm" %>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card-body">
                <form runat="server" id="formlogin">
                    ...
                    <div class="text-center">
                        <a class="d-block small mt-3" href="frm_Register.aspx">Register an Account</a>
                        <a class="d-block small mt-3 btn btn-success" href="admin/Login.aspx">LOGIN WITH ADMIN</a>
                     </div>
                </form>
